...
export const ROLE_LABELS = {
  ...
  diocesan_oeconomus: 'Diocesan Oeconomus',
  finance_staff: 'Finance Staff',
  parish_priest: 'Parish Priest',
  parish_secretary: 'Parish Secretary',
  seminary_rector: 'Seminary Rector',
  seminary_oeconomus: 'Seminary Oeconomus',
  school_superintendent: 'School Superintendent',
...
export const ALL_PERMISSIONS = [
  {
    ...
    icon: Eye,
    permissions: [
      { id: 'view_diocese', name: 'Diocesan Level', description: 'Full diocese-wide access. Can view and manage data across all parishes, seminaries, and schools under the Diocese of San Pablo.' },
      { id: 'view_parish', name: 'Parish Level', description: 'Restricted to a single assigned parish. Can only view and manage data within their designated parish community.' },
      { id: 'view_seminary', name: 'Seminary Level', description: 'Restricted to a single assigned seminary. Can only view and manage data within their designated seminary institution.' },
      { id: 'view_school', name: 'School Level', description: 'Restricted to an assigned school or cluster. Can only view and manage data within their designated diocesan school or group of schools.' },
    ]
  },
  {
    ...
    icon: Zap,
    permissions: [
      { id: 'digital_twin', name: 'Digital Twin', description: 'Allows the user to launch scenario simulations and mirror other institution dashboards.' },
    ]
  },
  {
    ...
    icon: Heart,
    permissions: [
      { id: 'view_priests', name: 'Priest Profiles & Dashboard', description: 'Allows the user to view priest health trackers, assignments, and personnel dashboards.' },
      { id: 'manage_assignments', name: 'Priest Assignment Simulator', description: 'Allows the user to launch scenario planning and simulate clergy assignments.' }
    ]
  },
  {
  ...
  },
  {
    ...
    icon: Church,
    permissions: [
      { id: 'manage_entities', name: 'Manage Entity Management', description: 'Allows the user to manage and configure diocesan institutions, parishes, and schools.' },
    ]
  },
  {
    category: 'Projects',
    icon: Briefcase,
    permissions: [
      { id: 'manage_projects', name: 'Manage Projects', description: 'Allows the user to create, edit, and manage special diocesan and parish projects.' },
      { id: 'view_projects', name: 'View Projects Only', description: 'Allows the user to view project lists and details without administrative modifications.' },
    ]
  },
  {
    ...
    permissions: [
      ...
      { id: 'view_audit_logs', name: 'View Activity History', description: 'Can see a record of all actions taken by staff members in the system.' },
    ]
  },
  {
    ...
    icon: Bell,
    permissions: [
      { id: 'manage_announcements', name: 'Manage Announcements', description: 'Allows the user to create, edit, and publish announcements across the diocese.' },
      { id: 'view_announcements', name: 'View Announcements Only', description: 'Allows the user to view announcements and news bulletins without publishing rights.' },
    ]
  }
];
...
export const INITIAL_ROLES: UserRole[] = [
  // (Diocese Team)
  { id: 'bishop', name: 'Bishop', color: '#D4AF37', permissions: { view_diocese: true, view_parish: false, view_seminary: false, view_school: false, view_school_cluster: false, view_school_all: false, download_csv: true, upload_csv_admin: true, upload_csv_entity: true, create_users: true, manage_roles: true, digital_twin: true, manage_entities: true, manage_projects: true, view_projects: false, manage_announcements: true, view_announcements: false, view_priests: true, manage_assignments: true, view_audit_logs: true, view_parish_dashboard: true, view_seminary_dashboard: true, view_school_dashboard: true, manage_own_institution: false } },
  { id: 'chancellor', name: 'Chancellor', color: '#8B5CF6', permissions: { view_diocese: true, view_parish: false, view_seminary: false, view_school: false, view_school_cluster: false, view_school_all: false, download_csv: false, upload_csv_admin: false, upload_csv_entity: false, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: false, view_projects: false, manage_announcements: true, view_announcements: false, view_priests: true, manage_assignments: true, view_audit_logs: false, view_parish_dashboard: false, view_seminary_dashboard: false, view_school_dashboard: false, manage_own_institution: false } },
  { id: 'diocesan_oeconomus', name: 'Diocesan Oeconomus', color: '#1E3A8A', permissions: { view_diocese: true, view_parish: false, view_seminary: false, view_school: false, view_school_cluster: false, view_school_all: false, download_csv: true, upload_csv_admin: true, upload_csv_entity: true, create_users: true, manage_roles: true, digital_twin: true, manage_entities: true, manage_projects: true, view_projects: false, manage_announcements: true, view_announcements: false, view_priests: true, manage_assignments: true, view_audit_logs: true, view_parish_dashboard: true, view_seminary_dashboard: true, view_school_dashboard: true, manage_own_institution: false } },
  { id: 'finance_staff', name: 'Finance Staff', color: '#3B82F6', permissions: { view_diocese: true, view_parish: false, view_seminary: false, view_school: false, view_school_cluster: false, view_school_all: false, download_csv: true, upload_csv_admin: true, upload_csv_entity: true, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: true, view_projects: false, manage_announcements: false, view_announcements: true, view_priests: true, manage_assignments: false, view_audit_logs: false, view_parish_dashboard: true, view_seminary_dashboard: true, view_school_dashboard: true, manage_own_institution: false } },

  // (Parish Team)
  { id: 'parish_priest', name: 'Parish Priest', color: '#059669', permissions: { view_diocese: false, view_parish: true, view_seminary: false, view_school: false, view_school_cluster: false, view_school_all: false, download_csv: true, upload_csv_admin: false, upload_csv_entity: true, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: true, view_projects: false, manage_announcements: false, view_announcements: true, view_priests: true, manage_assignments: true, view_audit_logs: false, view_parish_dashboard: true, view_seminary_dashboard: false, view_school_dashboard: false, manage_own_institution: true } },
  { id: 'parish_secretary', name: 'Parish Secretary', color: '#10B981', permissions: { view_diocese: false, view_parish: true, view_seminary: false, view_school: false, view_school_cluster: false, view_school_all: false, download_csv: true, upload_csv_admin: false, upload_csv_entity: true, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: true, view_projects: false, manage_announcements: false, view_announcements: true, view_priests: false, manage_assignments: false, view_audit_logs: false, view_parish_dashboard: true, view_seminary_dashboard: false, view_school_dashboard: false, manage_own_institution: true } },

  // (Seminary Team)
  { id: 'seminary_rector', name: 'Rector', color: '#DC2626', permissions: { view_diocese: false, view_parish: false, view_seminary: true, view_school: false, view_school_cluster: false, view_school_all: false, download_csv: true, upload_csv_admin: false, upload_csv_entity: true, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: true, view_projects: false, manage_announcements: false, view_announcements: true, view_priests: true, manage_assignments: true, view_audit_logs: false, view_parish_dashboard: false, view_seminary_dashboard: true, view_school_dashboard: false, manage_own_institution: true } },
  { id: 'seminary_oeconomus', name: 'Seminary Oeconomus', color: '#EF4444', permissions: { view_diocese: false, view_parish: false, view_seminary: true, view_school: false, view_school_cluster: false, view_school_all: false, download_csv: true, upload_csv_admin: false, upload_csv_entity: true, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: true, view_projects: false, manage_announcements: false, view_announcements: true, view_priests: false, manage_assignments: false, view_audit_logs: false, view_parish_dashboard: false, view_seminary_dashboard: true, view_school_dashboard: false, manage_own_institution: true } },

  // (School Team)
  { id: 'school_superintendent', name: 'School Superintendent', color: '#6D28D9', permissions: { view_diocese: false, view_parish: false, view_seminary: false, view_school: false, view_school_cluster: false, view_school_all: true, download_csv: true, upload_csv_admin: false, upload_csv_entity: true, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: true, view_projects: false, manage_announcements: false, view_announcements: true, view_priests: false, manage_assignments: false, view_audit_logs: false, view_parish_dashboard: false, view_seminary_dashboard: false, view_school_dashboard: true, manage_own_institution: false } },
  { id: 'finance_supervisor', name: 'Finance Supervisor', color: '#7C3AED', permissions: { view_diocese: false, view_parish: false, view_seminary: false, view_school: false, view_school_cluster: true, view_school_all: false, download_csv: true, upload_csv_admin: false, upload_csv_entity: true, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: false, view_projects: true, manage_announcements: false, view_announcements: true, view_priests: false, manage_assignments: false, view_audit_logs: false, view_parish_dashboard: false, view_seminary_dashboard: false, view_school_dashboard: true, manage_own_institution: false } },
  { id: 'finance_officer', name: 'Finance Officer', color: '#8B5CF6', permissions: { view_diocese: false, view_parish: false, view_seminary: false, view_school: true, view_school_cluster: false, view_school_all: false, download_csv: true, upload_csv_admin: false, upload_csv_entity: true, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: true, view_projects: false, manage_announcements: false, view_announcements: true, view_priests: false, manage_assignments: false, view_audit_logs: false, view_parish_dashboard: false, view_seminary_dashboard: false, view_school_dashboard: true, manage_own_institution: true } },
  { id: 'school_principal', name: 'School Principal', color: '#A78BFA', permissions: { view_diocese: false, view_parish: false, view_seminary: false, view_school: true, view_school_cluster: false, view_school_all: false, download_csv: false, upload_csv_admin: false, upload_csv_entity: false, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: false, view_projects: true, manage_announcements: false, view_announcements: true, view_priests: false, manage_assignments: false, view_audit_logs: false, view_parish_dashboard: false, view_seminary_dashboard: false, view_school_dashboard: true, manage_own_institution: true } }
];
