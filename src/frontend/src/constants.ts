    ...
    permissions: [
      {
        ...
        name: 'Diocesan Level',
        description:
          'Full diocese-wide access. Can view and manage data across all parishes, seminaries, and schools under the Diocese of San Pablo.',
      },
      {
        id: 'view_parish',
        name: 'Parish Level',
        description:
          'Restricted to a single assigned parish. Can only view and manage data within their designated parish community.',
      },
      {
        id: 'view_seminary',
        name: 'Seminary Level',
        description:
          'Restricted to a single assigned seminary. Can only view and manage data within their designated seminary institution.',
      },
      {
        id: 'view_school',
        name: 'School Level',
        description:
          'Restricted to an assigned school or cluster. Can only view and manage data within their designated diocesan school or group of schools.',
      },
    ],
  },
  {
    ...
    permissions: [
      {
        ...
        description: 'Allows the user to manage and configure diocesan institutions, parishes, and schools.',
      },
    ],
  },
  {
    ...
    permissions: [
      {
        ...
        description: 'Allows the user to create, edit, and manage special diocesan and parish projects.',
      },
      {
        id: 'view_projects',
  ...
  },
  {
    ...
    permissions: [
      ...
      },
      {
        ...
        description: 'Can see a record of all actions taken by staff members in the system.',
      },
    ],
  },
  {
...
export const INITIAL_ROLES: UserRole[] = [
  ...
  {
    id: 'diocesan_oeconomus',
    name: 'Diocesan Oeconomus',
    color: '#1E3A8A',
    permissions: {
      view_diocese: true,
      view_parish: false,
  ...
  {
    id: 'seminary_oeconomus',
    name: 'Seminary Oeconomus',
    color: '#EF4444',
    permissions: {
      view_diocese: false,
      view_parish: false,
