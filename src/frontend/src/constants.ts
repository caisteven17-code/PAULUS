...
export const ALL_PERMISSIONS = [
  {
    ...
    icon: Eye,
    permissions: [
      { id: 'view_diocese', name: 'Diocesan Level', description: 'Allows the user to view all records across the entire diocese.' },
      { id: 'view_parish', name: 'Parish Level', description: 'Allows the user to view records specific to their assigned parish.' },
      { id: 'view_seminary', name: 'Seminary Level', description: 'Allows the user to view records specific to their assigned seminary.' },
      { id: 'view_school', name: 'School Level', description: 'Allows the user to view records specific to their assigned school.' },
    ]
  },
  {
  ...
  },
  {
    ...
    permissions: [
      ...
      { id: 'view_audit_logs', name: 'View Audit Logs', description: 'Allows the user to view administrative action audit logs.' },
    ]
  },
  {
...
export const INITIAL_ROLES: UserRole[] = [
  ...
  { id: 'finance_staff', name: 'Finance Staff', color: '#3B82F6', permissions: { view_diocese: true, view_parish: false, view_seminary: false, view_school: false, view_school_cluster: false, view_school_all: false, download_csv: true, upload_csv_admin: true, upload_csv_entity: true, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: false, view_projects: true, manage_announcements: false, view_announcements: true, view_priests: true, manage_assignments: false, view_audit_logs: false } },

  // (Parish Team)
  { id: 'parish_priest', name: 'Parish Priest', color: '#059669', permissions: { view_diocese: false, view_parish: true, view_seminary: false, view_school: false, view_school_cluster: false, view_school_all: false, download_csv: true, upload_csv_admin: false, upload_csv_entity: true, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: true, view_projects: true, manage_announcements: true, view_announcements: true, view_priests: true, manage_assignments: true, view_audit_logs: false } },
  { id: 'parish_secretary', name: 'Parish Secretary', color: '#10B981', permissions: { view_diocese: false, view_parish: true, view_seminary: false, view_school: false, view_school_cluster: false, view_school_all: false, download_csv: true, upload_csv_admin: false, upload_csv_entity: true, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: true, view_projects: true, manage_announcements: true, view_announcements: true, view_priests: false, manage_assignments: false, view_audit_logs: false } },
  ...
  { id: 'school_principal', name: 'School Principal', color: '#A78BFA', permissions: { view_diocese: false, view_parish: false, view_seminary: false, view_school: true, view_school_cluster: false, view_school_all: false, download_csv: true, upload_csv_admin: false, upload_csv_entity: true, create_users: false, manage_roles: false, digital_twin: false, manage_entities: false, manage_projects: true, view_projects: true, manage_announcements: true, view_announcements: true, view_priests: true, manage_assignments: true, view_audit_logs: false } }
];
