  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 flex flex-col h-full shadow-sm hover:shadow-md transition-all group">
      <div className="flex items-center gap-4 mb-4">
        <div className={`w-12 h-12 ${meta.bg} rounded-xl flex items-center justify-center border group-hover:scale-110 transition-transform`}>
...
export function DataManagementControl() {
  ...
  const isSchool = permissions.view_school === true || permissions.view_school_cluster === true || permissions.view_school_all === true;
  ...
  const templatesToRender = useMemo(() => {
    ...
    if (isDiocese || isSchool) {
      list.push({
        title: "School",
        description: "Upload school financial data, including tuition collections, operating budgets, and personnel expenses.",
