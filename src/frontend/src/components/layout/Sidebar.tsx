        ...
        >
          ...
          <nav className="flex-1 px-3 space-y-1 overflow-y-auto scrollbar-hide">
            ...
            {(permissions.view_events === true || permissions.manage_events === true) &&
              (() => {
                const isActive = activeTab === 'events';
                return (
                  <button
                  ...
                  <button
                    onClick={() => {
                      if (permissions.create_users) onNavigate('admin-user-management');
                        ...
                        permissions.download_csv ||
                        permissions.upload_csv_admin ||
                        permissions.upload_csv_entity
                      )
                    ...
                    >
                      {[
                        ...
                        },
                        {
                          ...
                          icon: FileText,
                          show: permissions.download_csv === true || permissions.upload_csv_admin === true,
                        },
                        {
                          id: 'admin-liturgical',
