        ...
        <div className="max-w-[1600px] mx-auto px-4 md:px-8">
          ...
          <div className="mt-24 pt-20 border-t border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {institutionStats.map((card, index) => (
                ...
                >
                  <div
                    className={`w-12 md:w-14 h-12 md:h-14 rounded-xl md:rounded-2xl flex items-center justify-center mb-4 md:mb-6 transition-transform group-hover:scale-110 duration-500 ${
                      card.color === 'emerald'
                  ...
                  <div className="text-sm md:text-base font-bold text-gray-900 uppercase tracking-widest">
                    {card.title}
                  </div>
          ...
          <div className="mt-12 md:mt-16 lg:mt-20">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 md:mb-10 gap-3 sm:gap-4">
              ...
              <div className="text-[9px] sm:text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] md:tracking-[0.3em] whitespace-nowrap">
                Consolidated Funds
              </div>
            </div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-auto flex-wrap gap-2">
                    <div className="flex items-center gap-2 md:gap-3">
                      <div
                        className={`flex items-center gap-1 px-3 md:px-4 py-1.5 md:py-2 rounded-lg text-[10px] md:text-[11px] font-bold whitespace-nowrap ${
                          metric.trendDir === 'up'
                      ...
                      <span className="text-[9px] md:text-[10px] font-black text-gray-300 uppercase tracking-widest">
                        VS LY
                      </span>
                    </div>
                    {metric.icon && (
                ...
                <div className="rounded-[2rem] bg-gradient-to-br from-[#1f1f1f] via-[#2c2c2c] to-[#111111] p-8 md:p-10 text-white shadow-2xl">
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <p className="text-lg text-white/70 leading-relaxed max-w-2xl">
                      Launch a temporary what-if environment for parishes, seminaries, or schools. Test projected
                      collections, remittances, expenses, budget allocation, and file-based previews without affecting
                      official analytics.
                    </p>
                  </div>
                  <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="rounded-[1.5rem] bg-white/5 border border-white/10 p-5">
                      ...
                      <p className="mt-2 text-sm text-white/60">
                        No database write-back unless formally submitted and approved.
                      </p>
                    </div>
                    <div className="rounded-[1.5rem] bg-white/5 border border-white/10 p-5">
                      ...
                      <p className="mt-2 text-sm text-white/60">
                        Adjust collections, disbursements, remittances, expenses, and budgets.
                      </p>
                    </div>
                    <div className="rounded-[1.5rem] bg-white/5 border border-white/10 p-5">
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      <div className="rounded-2xl bg-white border border-gray-100 p-4">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          Review current standing, analytics, trends, and risk indicators
                        </p>
                      </div>
                      <div className="rounded-2xl bg-white border border-gray-100 p-4">
                        <p className="text-sm font-bold text-gray-900">3. Compare outcomes</p>
                        <p className="mt-1 text-sm text-gray-500">
                          Save or reload sandbox instances for internal planning
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex-1 space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-gray-500 leading-relaxed font-light max-w-xl">
                    Our mission is fueled by the collective efforts of our parishes, seminaries, and schools. This
                    breakdown reflects the strategic allocation of resources across our diocesan pillars.
                  </p>
                </div>
          ...
          <div className="mt-24 pt-20 border-t border-gray-100">
            <div className="space-y-8">
              ...
              <div className="space-y-4 mb-12">
                ...
                <p className="text-lg text-gray-500 leading-relaxed font-light max-w-2xl">
                  Monitor diocesan-wide submission status and manage entity classifications. Ensure accountability and
                  track financial reporting compliance across all parishes, seminaries, and schools.
                </p>
              </div>
