        ...
        {loading ? (
          ...
          <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_380px]">
            <section className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
              <div className="flex items-center justify-between"><div><h2 className="font-serif text-2xl font-bold text-slate-950">Movement plan</h2><p className="mt-1 text-xs font-medium text-slate-500">Include every affected priest. Resolve occupied destinations in this same plan.</p></div><button onClick={addMove} className="flex items-center gap-2 rounded-xl bg-slate-950 px-4 py-2.5 text-xs font-black text-white hover:bg-slate-800"><Plus className="h-4 w-4" />Add Priest</button></div>
