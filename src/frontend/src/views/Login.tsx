    ...
    <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5">
      <div className="space-y-3.5 sm:space-y-4">
        ...
        <div className="flex justify-end">
          <a href="#" className="text-xs sm:text-sm text-[#E6C27A] hover:text-[#D4AF37] hover:underline transition-colors font-medium font-sans">
            Forgot Password?
          </a>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12 sm:py-16 overflow-y-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10 flex-shrink-0 relative z-10">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif font-semibold text-slate-900 tracking-tight leading-[1.15] mb-4 sm:mb-5">
            Legacy of <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#B5952F]">Faith</span>,<br />
            Precision of <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#B5952F]">Data</span>.
          </h1>
          ...
          {step === 'credentials' && (
            <div className="mt-6 sm:mt-8 border-t border-slate-800/80 pt-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="font-semibold text-slate-200 text-xs sm:text-sm tracking-wide">Demo Accounts (Click to Autofill)</p>
              </div>
              <div className="grid grid-cols-1 gap-2.5 text-xs text-slate-300">
                ...
                >
                  <span className="font-bold text-[#E6C27A] group-hover:text-white transition-colors font-sans">Parish Priest Access</span>
                ...
                <button
                  ...
                  className="flex flex-col items-start bg-slate-900/40 hover:bg-[#D4AF37]/10 border border-slate-800 hover:border-[#D4AF37]/30 rounded-xl p-3 text-left transition-all duration-200 group"
                >
                  <span className="font-bold text-[#E6C27A] group-hover:text-white transition-colors font-sans">Parish Secretary Access</span>
