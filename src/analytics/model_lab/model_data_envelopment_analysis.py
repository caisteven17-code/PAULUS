...
def train(df: pd.DataFrame) -> None:
    ...
    print_metric_table(
        agg,
        columns=["parish_name", "efficiency_score", "improvement_target_%"],
        percent_cols=["improvement_target_%"],
        decimal_cols={"efficiency_score": 3},
    )
...
if __name__ == "__main__":
    ...
    train(df)
    export_model_dashboard_preview("Data Envelopment Analysis", df)
