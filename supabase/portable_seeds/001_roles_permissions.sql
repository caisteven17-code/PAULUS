...
VALUES
  ...
  ('digital_twin', 'Digital Twin', 'Digital Twin', 'Allows the user to launch scenario simulations and mirror other institution dashboards.'),
  ...
  ('manage_own_institution', 'Manage Own Institution', 'Entity Management', 'Allows the user to update their assigned institution profile.'),
...
VALUES
  ...
  ('seminary_oeconomus', 'manage_own_institution', true),
  ...
  ('finance_officer', 'manage_own_institution', true),
  ('finance_officer', 'view_school_dashboard', true),
  ('school_principal', 'view_school', true),
  ('school_principal', 'manage_own_institution', true),
